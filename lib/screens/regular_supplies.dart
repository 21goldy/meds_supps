...
class RegularSupplies extends StatefulWidget {
  const RegularSupplies({Key? key}) : super(key: key);

  @override
  State<RegularSupplies> createState() => _RegularSuppliesState();
}

class _RegularSuppliesState extends State<RegularSupplies> {
        ...
        body: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: LoginFields(
                  formHintText: 'Supplies needed',
                  formPrefixIcon: Icons.add,
                  obscureText: false,
                  onChanged: (v) {
                    print(v);
                    supplies = v;
